...
# 사용 예제
input_folder = "/home/a/A_2024_selfcode/NEW-PCB_Yolo/dataset/2_raw_json_labels"  # JSON 파일들이 담긴 폴더 경로
output_folder = "/home/a/A_2024_selfcode/NEW-PCB_Yolo/dataset/3_new_raw_json_labels"  # 수정된 JSON 파일들을 저장할 폴더 경로
